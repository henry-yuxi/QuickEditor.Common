namespace QuickEditor.Common
{
    ...
    public class QuickEditorCoroutines
    {
        public class QEditorCoroutine
        {
            ...
            public QEditorCoroutine(IEnumerator routine, int ownerHash, string ownerType)
            {
            ...
            public QEditorCoroutine(string methodName, int ownerHash, string ownerType)
            {
        ...
        {
            public QEditorCoroutine coroutine;
        ...
        private static QuickEditorCoroutines instance = null;

        private Dictionary<string, List<QEditorCoroutine>> coroutineDict = new Dictionary<string, List<QEditorCoroutine>>();
        private List<List<QEditorCoroutine>> tempCoroutineList = new List<List<QEditorCoroutine>>();

        private Dictionary<string, Dictionary<string, QEditorCoroutine>> coroutineOwnerDict =
            new Dictionary<string, Dictionary<string, QEditorCoroutine>>();
        ...
        public static QEditorCoroutine StartCoroutine(IEnumerator routine, object thisReference)
        {
        ...
        /// <param name="thisReference">Reference to the instance of the class containing the method.</param>
        public static QEditorCoroutine StartCoroutine(string methodName, object thisReference)
        {
        ...
        /// <param name="thisReference">Reference to the instance of the class containing the method.</param>
        public static QEditorCoroutine StartCoroutine(string methodName, object value, object thisReference)
        {
        ...
        private static void CreateInstanceIfNeeded()
        {
            if (instance == null)
            {
                instance = new QuickEditorCoroutines();
                instance.Initialize();
            }
        }
        ...
        private QEditorCoroutine CreateCoroutine(IEnumerator routine, object thisReference)
        {
            return new QEditorCoroutine(routine, thisReference.GetHashCode(), thisReference.GetType().ToString());
        }

        private QEditorCoroutine CreateCoroutineFromString(string methodName, object thisReference)
        {
            return new QEditorCoroutine(methodName, thisReference.GetHashCode(), thisReference.GetType().ToString());
        }
        ...
        private static bool Process(QEditorCoroutine coroutine)
        {
            ...
            {
                coroutine.currentYield = new YieldNestedCoroutine { coroutine = (QEditorCoroutine)current };
            }
            else
            {
                Debug.LogException(
