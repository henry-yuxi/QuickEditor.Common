...
{
    public class QuickReorderableList
    {
        ...
        public delegate void ActionDelegate(QuickReorderableList list);

        public delegate bool ActionBoolDelegate(QuickReorderableList list);

        public delegate void AddDropdownDelegate(Rect buttonRect, QuickReorderableList list);

        public delegate Object DragDropReferenceDelegate(Object[] references, QuickReorderableList list);

        public delegate void DragDropAppendDelegate(Object reference, QuickReorderableList list);

        public delegate float GetElementHeightDelegate(SerializedProperty element);

        public delegate float GetElementsHeightDelegate(QuickReorderableList list);
        ...
        public delegate void SurrogateCallback(SerializedProperty element, Object objectReference, QuickReorderableList list);
        ...
        public QuickReorderableList(SerializedProperty list)
            : this(list, true, true, true)
        {
        }

        public QuickReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
            : this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null)
        {
        }

        public QuickReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon)
            : this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon)
        {
        }

        public QuickReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon)
        {
            if (list == null)
            {
		...
		*/
        ...
        public struct Surrogate
        {
            ...
            public void Invoke(SerializedProperty element, Object objectReference, QuickReorderableList list)
            {
